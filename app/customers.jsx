  ...
  render() {
    return (
      <div id="new_part" className="position_absolute animation_one">
        ...
        <div className="edit_part_div">
          <span className="edit_part_div_name">邮箱:</span>
          <span className="edit_part_div_input_wrap"><input type="text" className="edit_part_div_input" id="new_email"/></span>
        </div>
        <div className="edit_part_div">
          <span className="edit_part_div_name">状态:</span>
          <span className="edit_part_div_input_wrap"><input type="text" className="edit_part_div_input" id="new_state"/></span>
        </div>
